    ...
    return (
        <div className="flex flex-col justify-center items-center bg-gray-50 px-4 sm:px-6 lg:px-8 py-12 min-h-screen">
            ...
            <div className="flex items-center mb-8">
                <img src={logo} alt="ShopSpot Logo" className="mr-2 w-12 h-12" />
                <span className="font-bold text-gray-900 text-2xl">ShopSpot Online</span>
            </div>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            <input
                                ...
                                name="remember-me"
                                type="checkbox"
                                className="border-gray-300 rounded focus:ring-indigo-500 w-4 h-4 text-indigo-600 transition-all duration-200 cursor-pointer"
                            />
